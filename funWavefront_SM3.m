function [Wrms] = funWavefront_SM3(r, U1, y1, H_array)
% funWavefront_SM3 - 计算离轴系统全视场下的平均波前 (自适应 SPH/CON 版, M3上)
    ...
    %% 计算各个表面球面Seidel贡献
    U3 = U1/ ((1+(-2).*r(1).^(-1).*r(5)+(-1).*((-2).*r(1).^(-1)+2.*r(2).^(-1).*(1+(-2).* ...
     r(1).^(-1).*r(5))).*r(6)));
    ...
    S2_sp_surface1 = (-2).*r(1).^(-3).*r(2).^(-1).*(r(1).*(r(2)+(-2).*r(6))+2.*r(5).*r(6)+r(2).*((-1).* ...
      r(5)+r(6))).*U3.*y1.^3;
    S2_sp_surface2 = (-2).*r(1).^(-3).*r(2).^(-3).*(r(1)+(-2).*r(5)).^2.*(r(1)+(-2).*(r(2)+r(5))).*( ...
      r(2)+(-1).*r(6)).*U3.*y1.^3;
    S2_sp_surface3 =(-2).*r(1).^(-3).*r(2).^(-3).*r(3).^(-2).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2).* ...
      r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^2.*(4.*r(5).*(r(3)+r(6))+2.*r(2).*(r(3)+(-1).*r(5)+ ...
      r(6))+r(1).*(r(2)+(-2).*(r(3)+r(6)))).*U3.*y1.^3;
    S2_sp_surface4 = 2.*r(1).^(-3).*r(2).^(-3).*r(3).^(-3).*r(4).^(-3).*(r(4)+r(7)).*(8.*r(5).*r(6).* ...
      r(7)+4.*r(2).*((-1).*r(5)+r(6)).*r(7)+4.*r(3).*r(5).*((-1).*r(6)+r(7))+2.*r(2).*r(3).*( ...
      r(5)+(-1).*r(6)+r(7))+r(1).*((-1).*r(2).*r(3)+2.*r(3).*r(6)+2.*r(2).*r(7)+(-2).*r(3).* ...
      r(7)+(-4).*r(6).*r(7))).^2.*((-4).*r(2).*(r(5)+(-1).*r(6)).*(r(4)+r(7))+8.*r(5).* ...
      r(6).*(r(4)+r(7))+4.*r(3).*r(5).*(r(4)+(-1).*r(6)+r(7))+2.*r(2).*r(3).*(r(4)+r(5)+(-1).* ...
      r(6)+r(7))+(-1).*r(1).*(4.*r(6).*(r(4)+r(7))+2.*r(3).*(r(4)+(-1).*r(6)+r(7))+r(2).*(r(3)+( ...
      -2).*(r(4)+r(7))))).*U3.*y1.^3;

    S3_sp_surface1 =(-2).*r(1).^(-3).*r(2).^(-2).*(r(1).*(r(2)+(-2).*r(6))+2.*r(5).*r(6)+r(2).*((-1).* ...
      r(5)+r(6))).^2.*U3.^2.*y1.^2;
    S3_sp_surface2 = 2.*r(1).^(-2).*r(2).^(-3).*(r(1)+(-2).*r(5)).^2.*(r(2)+(-1).*r(6)).^2.*U3.^2.* y1.^2;
    S3_sp_surface3 = (-2).*r(1).^(-2).*r(2).^(-2).*r(3).^(-1).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2).* ...
      r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^2.*U3.^2.*y1.^2;
    S3_sp_surface4 = 2.*r(1).^(-2).*r(2).^(-2).*r(3).^(-2).*r(4).^(-3).*(r(4)+r(7)).^2.*(8.*r(5).* ...
      r(6).*r(7)+4.*r(2).*((-1).*r(5)+r(6)).*r(7)+4.*r(3).*r(5).*((-1).*r(6)+r(7))+2.*r(2).* ...
      r(3).*(r(5)+(-1).*r(6)+r(7))+r(1).*((-1).*r(2).*r(3)+2.*r(3).*r(6)+2.*r(2).*r(7)+(-2).* ...
      r(3).*r(7)+(-4).*r(6).*r(7))).^2.*U3.^2.*y1.^2;
    ...
    S2_asp_surface1 = (-2).*r(12).*r(1).^(-3).*(r(5)+(-1).*r(6)+(-2).*r(2).^(-1).*r(5).*r(6)).*U3.* y1.^3;
    S2_asp_surface2 = (-2).*r(13).*r(1).^(-3).*r(2).^(-3).*(r(1)+(-2).*r(5)).^3.*r(6).*U3.*y1.^3;
    S2_asp_surface3 = 0;
    S2_asp_surface4 = (-2).*r(15).*r(1).^(-3).*r(2).^(-3).*r(3).^(-3).*r(4).^(-3).*r(7).*(r(1).*((-2).* ...
      r(3).*r(6)+r(2).*(r(3)+(-2).*r(7))+2.*r(3).*r(7)+4.*r(6).*r(7))+(-2).*(4.*r(5).*r(6).* ...
      r(7)+2.*r(2).*((-1).*r(5)+r(6)).*r(7)+2.*r(3).*r(5).*((-1).*r(6)+r(7))+r(2).*r(3).*(r(5)+( ...
      -1).*r(6)+r(7)))).^3.*U3.*y1.^3;
    ...
    S3_asp_surface1 = (-2).*r(12).*r(1).^(-3).*(r(6)+r(5).*((-1)+2.*r(2).^(-1).*r(6))).^2.*U3.^2.* y1.^2;
    S3_asp_surface2 = 2.*r(13).*r(1).^(-2).*r(2).^(-3).*(r(1)+(-2).*r(5)).^2.*r(6).^2.*U3.^2.*y1.^2; 
    S3_asp_surface3 = 0;
    S3_asp_surface4 = 2.*r(15).*r(1).^(-2).*r(2).^(-2).*r(3).^(-2).*r(4).^(-3).*r(7).^2.*(8.*r(5).*r(6).* ...
      r(7)+4.*r(2).*((-1).*r(5)+r(6)).*r(7)+4.*r(3).*r(5).*((-1).*r(6)+r(7))+2.*r(2).*r(3).*( ...
      r(5)+(-1).*r(6)+r(7))+r(1).*((-1).*r(2).*r(3)+2.*r(3).*r(6)+2.*r(2).*r(7)+(-2).*r(3).* ...
      r(7)+(-4).*r(6).*r(7))).^2.*U3.^2.*y1.^2;
    ...
    I1 = -(r(1).^(-1).*(r(5)+(-1).*(1+2.*r(2).^(-1).*r(5)).*r(6)).*U3+(1+(-2).*r(1).^(-1) ...
      .*r(5)+(-1).*((-2).*r(1).^(-1)+2.*r(2).^(-1).*(1+(-2).*r(1).^(-1).*r(5))).* ...
      r(6)).*U3);
    I2 =-((-1).*r(2).^(-1).*r(6).*U3+(-1).*(1+(-2).*r(2).^(-1).*r(6)).*U3);
    I3 = -U3;
    I4 = -((-1).*U3+(-1).*r(4).^(-1).*r(7).*U3);
