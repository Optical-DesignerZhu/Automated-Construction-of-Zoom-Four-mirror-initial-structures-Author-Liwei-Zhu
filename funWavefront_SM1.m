function [Wrms] = funWavefront_SM1(r, U1, y1, H_array)
% funWavefront_SM1 - 计算离轴系统全视场下的平均波前 (自适应 SPH/CON 版, M1上)
    ...
    S2_sp_surface1 = (-2).*r(1).^(-3).*y1.^3.*(r(1).*U1+Y1);
    S2_sp_surface2 = (-2).*r(1).^(-3).*r(2).^(-3).*(r(1)+(-2).*r(5)).^2.*(r(2)+r(5)).*(r(1)+(-2).*( ...
      r(2)+r(5))).*U1.*y1.^3;
    S2_sp_surface3 = (-2).*r(1).^(-3).*r(2).^(-4).*r(3).^(-3).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2).* ...
      r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^2.*(2.*r(5).*(r(3)+r(6))+r(2).*(r(3)+(-1).*r(5)+r(6))) ...
      .*(4.*r(5).*(r(3)+r(6))+2.*r(2).*(r(3)+(-1).*r(5)+r(6))+r(1).*(r(2)+(-2).*(r(3)+r(6)))) ...
      .*U1.*y1.^3;
    S2_sp_surface4 =  (-2).*r(1).^(-3).*r(2).^(-4).*r(3).^(-4).*r(4).^(-3).*((-2).*r(2).*(r(5)+(-1) ...
      .*r(6)).*(r(4)+r(7))+4.*r(5).*r(6).*(r(4)+r(7))+2.*r(3).*r(5).*(r(4)+(-1).*r(6)+r(7))+r(2).* ...
      r(3).*(r(4)+r(5)+(-1).*r(6)+r(7))).*(4.*r(2).*(r(5)+(-1).*r(6)).*(r(4)+r(7))+(-8).* ...
      r(5).*r(6).*(r(4)+r(7))+(-4).*r(3).*r(5).*(r(4)+(-1).*r(6)+r(7))+(-2).*r(2).*r(3).*(r(4)+ ...
      r(5)+(-1).*r(6)+r(7))+r(1).*r(2).*(r(3)+(-2).*(r(4)+r(7)))+2.*r(1).*(2.*r(6).*(r(4)+r(7))+ ...
      r(3).*(r(4)+(-1).*r(6)+r(7)))).*(r(1).*((-2).*r(3).*r(6)+r(2).*(r(3)+(-2).*r(7))+2.* ...
      r(3).*r(7)+4.*r(6).*r(7))+(-2).*(4.*r(5).*r(6).*r(7)+2.*r(2).*((-1).*r(5)+r(6)).*r(7)+ ...
      2.*r(3).*r(5).*((-1).*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1).*r(6)+r(7)))).^2.*U1.*y1.^3;

    S3_sp_surface1 =(-2).*r(1).^(-3).*y1.^2.*(r(1).*U1+Y1).^2;
    S3_sp_surface2 = 2.*r(1).^(-2).*r(2).^(-3).*(r(1)+(-2).*r(5)).^2.*(r(2)+r(5)).^2.*U1.^2.*y1.^2;
    S3_sp_surface3 = (-2).*r(1).^(-2).*r(2).^(-4).*r(3).^(-3).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2).* ...
      r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^2.*(2.*r(5).*(r(3)+r(6))+r(2).*(r(3)+(-1).*r(5)+r(6))) ...
      .^2.*U1.^2.*y1.^2;
    S3_sp_surface4 = 2.*r(1).^(-2).*r(2).^(-4).*r(3).^(-4).*r(4).^(-3).*((-2).*r(2).*(r(5)+(-1).* ...
      r(6)).*(r(4)+r(7))+4.*r(5).*r(6).*(r(4)+r(7))+2.*r(3).*r(5).*(r(4)+(-1).*r(6)+r(7))+r(2).* ...
      r(3).*(r(4)+r(5)+(-1).*r(6)+r(7))).^2.*(r(1).*((-2).*r(3).*r(6)+r(2).*(r(3)+(-2).*r(7))+ ...
      2.*r(3).*r(7)+4.*r(6).*r(7))+(-2).*(4.*r(5).*r(6).*r(7)+2.*r(2).*((-1).*r(5)+r(6)).* ...
      r(7)+2.*r(3).*r(5).*((-1).*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1).*r(6)+r(7)))).^2.*U1.^2.* y1.^2;
    ...
    S2_asp_surface1 = (-2).*r(12).*r(1).^(-3).*y1.^3.*Y1;
    S2_asp_surface2 = (-2).*r(13).*r(2).^(-3).*r(5).*U1.*(y1+(-2).*r(1).^(-1).*r(5).*y1).^3;
    S2_asp_surface3 = (-2).*r(14).*r(1).^(-3).*r(2).^(-4).*r(3).^(-3).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2) ...
      .*r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^3.*(2.*r(5).*r(6)+r(2).*((-1).*r(5)+r(6))).*U1.* y1.^3;
    S2_asp_surface4 = (-2).*r(15).*r(1).^(-3).*r(2).^(-4).*r(3).^(-4).*r(4).^(-3).*(4.*r(5).*r(6).*r(7)+ ...
      2.*r(2).*((-1).*r(5)+r(6)).*r(7)+2.*r(3).*r(5).*((-1).*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1) ...
      .*r(6)+r(7))).*(r(1).*((-2).*r(3).*r(6)+r(2).*(r(3)+(-2).*r(7))+2.*r(3).*r(7)+4.*r(6).* ...
      r(7))+(-2).*(4.*r(5).*r(6).*r(7)+2.*r(2).*((-1).*r(5)+r(6)).*r(7)+2.*r(3).*r(5).*((-1) ...
      .*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1).*r(6)+r(7)))).^3.*U1.*y1.^3;
    ...
    S3_asp_surface1 = (-2).*r(12).*r(1).^(-3).*y1.^2.*Y1.^2;
    S3_asp_surface2 = 2.*r(13).*r(2).^(-3).*r(5).^2.*(1+(-2).*r(1).^(-1).*r(5)).^2.*U1.^2.*y1.^2;
    S3_asp_surface3 = (-2).*r(14).*r(1).^(-2).*r(2).^(-4).*r(3).^(-3).*((-2).*r(2).*r(5)+r(1).*(r(2)+(-2) ...
      .*r(6))+2.*r(2).*r(6)+4.*r(5).*r(6)).^2.*(2.*r(5).*r(6)+r(2).*((-1).*r(5)+r(6))).^2.* U1.^2.*y1.^2;
    S3_asp_surface4 = 2.*r(15).*r(1).^(-2).*r(2).^(-4).*r(3).^(-4).*r(4).^(-3).*(4.*r(5).*r(6).*r(7)+2.* ...
      r(2).*((-1).*r(5)+r(6)).*r(7)+2.*r(3).*r(5).*((-1).*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1).* ...
      r(6)+r(7))).^2.*(r(1).*((-2).*r(3).*r(6)+r(2).*(r(3)+(-2).*r(7))+2.*r(3).*r(7)+4.*r(6).* ...
      r(7))+(-2).*(4.*r(5).*r(6).*r(7)+2.*r(2).*((-1).*r(5)+r(6)).*r(7)+2.*r(3).*r(5).*((-1) ...
      .*r(6)+r(7))+r(2).*r(3).*(r(5)+(-1).*r(6)+r(7)))).^2.*U1.^2.*y1.^2;
    ...
    I1 = -(U1+r(1).^(-1).*Y1);
    I2 = -((-1).*U1+(-1).*r(2).^(-1).*r(5).*U1);
    I3 = -((1+2.*r(2).^(-1).*r(5)).*U1+r(3).^(-1).*(r(6)+(-1).*r(5).*(1+(-2).*r(2).^(-1).*r(6))).*U1);
    I4 = -((-1).*(1+2.*r(3).^(-1).*r(6)+(-1).*r(5).*(2.*r(3).^(-1)+(-2).*r(2).^(-1).*(1+2.*r(3).^(-1).*r(6)))).*U1+r(4).^(-1).*((-1).*r(7)+r(6).*(1+(-2).*r(3).^(-1).*r(7))+(-1).*r(5).*(1+(-2).*r(3).^(-1).*r(7)+(-2).*r(2).^(-1).*((-1).*r(7)+r(6).*(1+(-2).*r(3).^(-1).*r(7))))).*U1);
